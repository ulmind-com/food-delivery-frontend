...
export function AddressFormModal({ isOpen, onClose, onSuccess, editAddress }: AddressFormModalProps) {
    ...
    useEffect(() => {
        if (editAddress) {
            ...
            setForm({ type: "HOME", addressLine1: "", addressLine2: "", city: "", state: "", postalCode: "", mobile: "" });
        }
    }, [editAddress, isOpen]);
            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed inset-x-0 bottom-0 z-[201] rounded-t-3xl bg-background shadow-2xl sm:inset-x-auto sm:left-1/2 sm:top-1/2 sm:w-[500px] sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-2xl"
                    >
                        {/* Header */}
                        ...
                        <form onSubmit={handleSubmit} className="overflow-y-auto px-6 pb-8 pt-5" style={{ maxHeight: "80vh" }}>
                            ...
                            {/* Fields */}
                            {[
                                { key: "addressLine1", label: "Address Line 1 *", placeholder: "House no, Building, Street" },
                                { key: "addressLine2", label: "Address Line 2", placeholder: "Area, Colony (optional)" },
